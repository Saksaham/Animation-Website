    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg-zinc-100 pt-1">
              ...
              <div className="w-fit flex">
                {index === 1 && (
                  <motion.div
                    ...
                    className="w-[9vw] h-[5.7vw] bg-green-500 relative -top-[1vw] rounded-md mr-[1vw]"
                  >
                    
                    <motion.svg
                      initial={{ width: 0 , height:0 }}
                      animate={{ width: 72 ,height:30 }}
                      transition={{ ease: [0.76, 0, 0.24, 1], duration: 1 }}
      ...
      <div className="border-t-[1px] border-zinc-800 mt-20 flex justify-between items-center py-5 px-20">
        ...
        <div className="start flex items-center justify-center gap-2">
          <div className="px-5 py-2 rounded-full border-[1px] border-zinc-600 uppercase text-[13px] font-light">
            start the project
          </div>
          <div className="w-9 h-9 rounded-full border-[1px] border-zinc-600 flex items-center justify-center">
